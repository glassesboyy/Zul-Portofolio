  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[250px] max-w-full relative rounded-xl border border-violet-500/20 flex-shrink-0 px-4 py-3 md:w-[300px]"
            style={{
              background:
                "linear-gradient(180deg, rgba(109, 40, 217, 0.05), rgba(17, 24, 39, 0.2))",
            }}
            key={item.name + idx}
          >
            <blockquote>
